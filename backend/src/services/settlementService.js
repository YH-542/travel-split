...
function calculateSettlement(payments, members) {
  ...
  for (const payment of payments) {
    ...
    const totalRatio = payment.splits.reduce((sum, s) => sum + s.ratio, 0);
    if (totalRatio > 0) {
 ...
 */
function generateShareText(eventName, settlements) {
...
module.exports = { calculateSettlement, minimizeTransfers, generateShareText };
